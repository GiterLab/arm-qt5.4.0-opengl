...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/work/cortex-A8/buildroot/output/host/usr")
  ...
  CONFIG["configure_args"] = " '--prefix=/work/cortex-A8/buildroot/output/host/usr' '--sysconfdir=/work/cortex-A8/buildroot/output/host/etc' '--localstatedir=/work/cortex-A8/buildroot/output/host/var' '--enable-shared' '--disable-static' '--disable-gtk-doc' '--disable-gtk-doc-html' '--disable-doc' '--disable-docs' '--disable-documentation' '--disable-debug' '--with-xmlto=no' '--with-fop=no' '--disable-dependency-tracking' '--disable-install-doc' '--without-ext=curses,openssl,readline' '--without-gmp' 'CC=/usr/bin/gcc' 'CFLAGS=-O2 -I/work/cortex-A8/buildroot/output/host/usr/include' 'LDFLAGS=-L/work/cortex-A8/buildroot/output/host/lib -L/work/cortex-A8/buildroot/output/host/usr/lib -Wl,-rpath,/work/cortex-A8/buildroot/output/host/usr/lib' 'CPPFLAGS=-I/work/cortex-A8/buildroot/output/host/usr/include' 'CXX=/usr/bin/g++' 'CXXFLAGS=-O2 -I/work/cortex-A8/buildroot/output/host/usr/include' 'CPP=/usr/bin/cpp'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/work/cortex-A8/buildroot/output/host/usr"
  ...
  CONFIG["CP"] = "cp"
  CONFIG["RM"] = "rm -f"
  CONFIG["PKG_CONFIG"] = "/work/cortex-A8/buildroot/output/host/usr/bin/pkg-config"
  CONFIG["PYTHON"] = ""
  CONFIG["DOXYGEN"] = ""
  CONFIG["DOT"] = ""
  CONFIG["DTRACE"] = ""
  ...
  CONFIG["CXXFLAGS"] = "-O2 -I/work/cortex-A8/buildroot/output/host/usr/include"
  CONFIG["CXX"] = "/usr/bin/g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/work/cortex-A8/buildroot/output/host/usr/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/work/cortex-A8/buildroot/output/host/lib -L/work/cortex-A8/buildroot/output/host/usr/lib -Wl,-rpath,/work/cortex-A8/buildroot/output/host/usr/lib -fstack-protector -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-O2 -I/work/cortex-A8/buildroot/output/host/usr/include -fPIC"
  ...
  CONFIG["localstatedir"] = "$(DESTDIR)/work/cortex-A8/buildroot/output/host/var"
  CONFIG["sharedstatedir"] = "$(prefix)/com"
  CONFIG["sysconfdir"] = "$(DESTDIR)/work/cortex-A8/buildroot/output/host/etc"
