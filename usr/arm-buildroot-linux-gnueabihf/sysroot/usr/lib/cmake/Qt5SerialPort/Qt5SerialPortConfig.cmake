...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5SerialPort" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5SerialPort_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.4.0"
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.4.0/QtSerialPort"
    )
    ...
    macro(_populate_SerialPort_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5SerialPort_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_SerialPort_check_file_exists(${imported_location})
