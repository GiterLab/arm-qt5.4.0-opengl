...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5ScriptTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5ScriptTools_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.4.0"
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.4.0/QtScriptTools"
    )
    ...
    macro(_populate_ScriptTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5ScriptTools_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_ScriptTools_check_file_exists(${imported_location})
