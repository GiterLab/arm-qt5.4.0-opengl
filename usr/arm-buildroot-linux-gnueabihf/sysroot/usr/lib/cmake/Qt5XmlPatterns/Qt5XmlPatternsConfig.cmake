...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.4.0"
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.4.0/QtXmlPatterns"
    )
    ...
    macro(_populate_XmlPatterns_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5XmlPatterns_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_XmlPatterns_check_file_exists(${imported_location})
