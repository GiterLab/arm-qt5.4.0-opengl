...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Svg" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Svg_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.4.0"
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.4.0/QtSvg"
    )
    ...
    macro(_populate_Svg_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Svg_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Svg_check_file_exists(${imported_location})
