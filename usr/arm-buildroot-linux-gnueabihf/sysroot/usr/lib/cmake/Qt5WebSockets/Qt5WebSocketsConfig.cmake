...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebSockets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebSockets_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.4.0"
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.4.0/QtWebSockets"
    )
    ...
    macro(_populate_WebSockets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebSockets_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_WebSockets_check_file_exists(${imported_location})
