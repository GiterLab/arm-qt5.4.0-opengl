...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Sensors" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Sensors_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(_Qt5Sensors_OWN_INCLUDE_DIRS "${_qt5Sensors_install_prefix}/include/qt5/" "${_qt5Sensors_install_prefix}/include/qt5/QtSensors")
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.4.0"
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.4.0/QtSensors"
    )
    ...
    macro(_populate_Sensors_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Sensors_check_file_exists(${imported_location})
