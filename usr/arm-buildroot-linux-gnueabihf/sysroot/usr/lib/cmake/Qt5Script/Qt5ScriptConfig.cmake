...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Script" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Script_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.4.0"
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.4.0/QtScript"
    )
    ...
    macro(_populate_Script_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Script_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Script_check_file_exists(${imported_location})
