...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebKit" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebKit_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/qt5/QtWebKit/5.4.0"
        "${_qt5WebKit_install_prefix}/include/qt5/QtWebKit/5.4.0/QtWebKit"
    )
    ...
    macro(_populate_WebKit_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebKit_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_WebKit_check_file_exists(${imported_location})
